...
const inprogress: NextPage = (props: any) => {
              ...
              <div className="p-2 md:p-24">
                ...
                <div className="grid grid-cols-2 gap-8 pt-12 md:pt-20">
                  <p className="mb-20 text-lg font-light ml-2 text-[#F5DFB3] sm:text-2xl xl:leading-normal">
                    Two Moons is in active development. Join our discord and
                    follow us on X to stay up to date on giveaways, airdrops,
                    system updates, and all new information.
                  </p>
                  <ul className="ml-4">
                    <a
